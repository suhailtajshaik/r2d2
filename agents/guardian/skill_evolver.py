...
SKILLS_DIR = "/home/r2d2/.openclaw/workspace/skills"
...
3. If improvements found (be selective — only update if genuinely better):
   - Update /home/r2d2/.openclaw/workspace/skills/{skill_name}/SKILL.md
   - Mirror to /home/r2d2/brain/skills/{skill_name}/SKILL.md
